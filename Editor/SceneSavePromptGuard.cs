...
namespace Submodules.Utility.Editor
{
    ...
    ///
    /// Toggle at <c>Tools ▸ Utility ▸ Suppress Scene Save Prompt</c>. Enable
    /// <c>Tools ▸ Utility ▸ ...Even For Edits Made While Focused</c> only if you want the
    /// aggressive mode that also discards your own unsaved scene edits.
    /// </summary>
    [InitializeOnLoad]
    public static class SceneSavePromptGuard
    {
        private const string EnabledMenu = "Tools/Utility/Suppress Scene Save Prompt";
        private const string AggressiveMenu = "Tools/Utility/Suppress Scene Save Prompt (Even For Edits Made While Focused)";
        private const string EnabledPref = "Submodules.Utility.SceneSavePromptGuard.Enabled";
        private const string AggressivePref = "Submodules.Utility.SceneSavePromptGuard.Aggressive";
