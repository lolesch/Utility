...
{
    /// <summary>
    /// The smallest real <see cref="AbstractPanel"/>: it counts <c>FadeIn</c> / <c>FadeOut</c>
    /// calls via the two hooks <see cref="AbstractPanel"/> already calls synchronously before
    ...
    /// </summary>
    public sealed class SpyPanel : AbstractPanel
    {
